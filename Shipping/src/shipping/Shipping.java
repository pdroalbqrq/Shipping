...
//                ArrayList<LeituraProtocolo> listaLeituraProtocolo = dadosL.listaLeituraProtocolo();
//                for (LeituraProtocolo listaP : listaLeituraProtocolo) {
//                    String mensagem = "";
//                    mensagem += " ID Acesso " + listaP.getIdAcesso();
//                    mensagem += " Referência " + listaP.getReferenciaProtocolo();
//                    mensagem += " Momento " + listaP.getData() + listaP.getHora();
//                    mensagem += " ID Envio " + listaP.getProtocolo().getIdEnvio();
