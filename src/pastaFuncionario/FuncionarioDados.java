...
public class FuncionarioDados extends Dados implements InterfaceFuncionario {
    ...
    /**
     * Método de criação de novos funcionários tabela: funcionarios parametros:
     * Matricula, NomeFuncionario e CodSetor
     *
     * @param fun
     * @throws Exception
     */
    ...
    public void cadastrarFuncionario(Funcionario fun) throws Exception {
        ...
        String sql = "INSERT INTO Funcionario (NomeFuncionario,CodSetor,senha)";
        sql += "VALUES (?,?,'12345')";
